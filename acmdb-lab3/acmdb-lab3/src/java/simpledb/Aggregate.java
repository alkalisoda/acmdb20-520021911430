...
public class Aggregate extends Operator {
	...
	// some code goes here
        ...
        if (gfieldType != null){
            ...
            names.add(td.getFieldName(this.gfield));
        }

        types.add(td.getFieldType(this.afield));
        names.add(td.getFieldName(this.afield));
	...
	// some code goes here
        ...
        if (gfieldType != null){
            types.add(gfieldType);
            names.add(td.getFieldName(gfield));
        }
        types.add(td.getFieldType(afield));
        names.add(td.getFieldName(afield));
